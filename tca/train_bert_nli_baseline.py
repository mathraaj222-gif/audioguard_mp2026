...
def run_training():
    ...
    summary = {
        ...
        "f1_macro": round(float(metrics["eval_f1_macro"]), 4),
        "precision_macro": round(float(metrics["eval_precision_macro"]), 4),
        "recall_macro": round(float(metrics["eval_recall_macro"]), 4),
