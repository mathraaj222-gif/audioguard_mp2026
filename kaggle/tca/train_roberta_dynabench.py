"""
train_roberta_dynabench.py — T4: RoBERTa Dynabench on Binary Davidson Dataset
=============================================================================
Model : facebook/roberta-hate-speech-dynabench-r4-target
Task  : Binary hate speech classification (hate vs not-hate)
Data  : Davidson et al. (remapped to binary)
"""
...
CONFIG = {
    ...
    "batch_size": 32,
    "max_length": 128,
    "output_dir": "./outputs/T4_roberta_dynabench/",
}
