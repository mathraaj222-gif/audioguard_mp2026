"""
train_deberta_small_ce.py — T5: DeBERTa-v3-Small Cross-Encoder on NLI Ethics Dataset
================================================================================
...
CONFIG = {
    ...
    "batch_size": 16,
    "max_length": 128,
    "output_dir": "./outputs/T5_deberta_small_ce/",
}
...
def run_training():
    ...
    def tokenize_function(examples):
        # CrossEncoder format: premise + hypothesis
        return tokenizer(
            examples["premise"],
            examples["hypothesis"],
            truncation=True,
